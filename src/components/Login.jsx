      ...
      <div className="top flex flex-col mt-7 items-center justify-center gap-[50px] ">
        ...
        <div>
          <img
            ...
            src="https://i.pinimg.com/736x/e9/6b/18/e96b18ffce8262f0980f081b06bfdeff.jpg"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="center mt-[70px] w-full">
        ...
        >
          <div className="item p-2 rounded-2xl h-[60px]  border-[1px] border-gray">
            ...
            <input
              className="w-full border-none outline-none h-full px-3 bg-transparent placeholder:text-[14px] text-gray-800 "
              type="text"
              name="username"
              required
              value={form.username}
              onChange={handlechange}
              placeholder="Username, email address or mobile no"
            />
          </div>
          ...
          <div className="item p-2 rounded-2xl h-[60px]  border-[1px] border-gray relative">
            ...
            <i
              ...
              ref={showRef}
              className="fa-regular fa-eye-slash   absolute right-6 top-4 text-xl text-gray-500 "
            ></i>
          </div>
          ...
          <h1 className="w-full mx-auto text-[14px] mt-1 flex items-center justify-center">
            Forgotten Password?
          </h1>
        </form>
      </div>
      <div className="bottom flex items-center w-full justify-center flex-col fixed bottom-0 ">
        <button className="border-[1.5px] text-blue-600 text-[14px] border-blue-700 w-[90%] py-2 rounded-3xl">
          Create new account{" "}
        </button>
        <img
          className="h-[60px] bg-red-600"
          src="https://i.pinimg.com/736x/0e/82/eb/0e82ebf53c1b2a19b7cc92ef74282029.jpg"
          alt=""
        />
      </div>
    </div>
